...
stock = read.csv("C:/Users/Priyanka/Documents/0. USF/4. Statistical Data Mining/HW2/SnP500.csv")
names(stock)[1]=c("Period")
colnames(stock) = tolower(make.names(colnames(stock)))
attach(stock)

#interest = read_excel(file.choose(), skip = 6)
interest = read_excel("C:/Users/Priyanka/Documents/0. USF/4. Statistical Data Mining/HW2/Interest Rate.xls", skip = 6)
...
dollar = read.csv("C:/Users/Priyanka/Documents/0. USF/4. Statistical Data Mining/HW2/Dollar.csv")
